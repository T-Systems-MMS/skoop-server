...
image:https://sonarcloud.io/api/project_badges/measure?project=io.knowledgeassets.myskills:myskills-server&metric=alert_status["SonarCloud Status", link="https://sonarcloud.io/dashboard?id=io.knowledgeassets.myskills:myskills-server"]
