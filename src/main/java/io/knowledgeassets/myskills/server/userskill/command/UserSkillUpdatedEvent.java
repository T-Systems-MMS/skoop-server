...
public class UserSkillUpdatedEvent implements Serializable {
	private final UserSkillAggregateKey id;
	private final Integer currentLevel;
	private final Integer desiredLevel;
	private final Integer priority;

	public UserSkillUpdatedEvent(UserSkillAggregateKey id, Integer currentLevel, Integer desiredLevel, Integer priority) {
		this.id = id;
