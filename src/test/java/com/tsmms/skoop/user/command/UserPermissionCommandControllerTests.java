...
class UserPermissionCommandControllerTests extends AbstractControllerTests {
	...
	@DisplayName("Grants permission to all users.")
	@Test
	void grantsPermissionToAllUsers() throws Exception {
		User owner = User.builder()
				.id("db87d46a-e4ca-451a-903b-e8533e0b924b")
				.userName("tester")
				.firstName("Toni")
		...
		final ClassPathResource body = new ClassPathResource("permissions/grant-permission-to-all-users.json");
