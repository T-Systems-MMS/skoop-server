...
class UserPermissionQueryControllerTests extends AbstractControllerTests {
	...
	@Test
	@DisplayName("Tests getting all outbound READ_USER_SKILLS user permissions granted to other users.")
	void testGettingAllOutboundReadUserSkillsUserPermissionsGrantedToOtherUsers() throws Exception {
		final User owner = User.builder()
				.id("adac977c-8e0d-4e00-98a8-da7b44aa5dd6")
				.userName("johndoe")
				.firstName("John")
		...
		given(userPermissionQueryService.getOutboundUserPermissionsByOwnerIdAndScope("adac977c-8e0d-4e00-98a8-da7b44aa5dd6", UserPermissionScope.READ_USER_SKILLS))
				.willReturn(Stream.of(
						UserPermission.builder()
								.owner(owner)
								.scope(UserPermissionScope.READ_USER_SKILLS)
	...
	@Test
	@DisplayName("Tests getting all inbound READ_USER_SKILLS user permissions granted by other users.")
	void testGettingAllInboundReadUserSkillsUserPermissionsGrantedByOtherUsers() throws Exception {
		final User owner = User.builder()
				.id("adac977c-8e0d-4e00-98a8-da7b44aa5dd6")
				.userName("johndoe")
				.firstName("John")
		...
		given(userPermissionQueryService.getInboundUserPermissionsByAuthorizedUserIdAndScope("adac977c-8e0d-4e00-98a8-da7b44aa5dd6", UserPermissionScope.READ_USER_SKILLS))
				.willReturn(Stream.of(
						UserPermission.builder()
								.owner(tester)
								.scope(UserPermissionScope.READ_USER_SKILLS)
