...
class UserSkillRepositoryTests {
	...
	void providesSkillsRelatedToGivenUserId() {
		...
		Assertions.assertThat(userSkills).containsExactlyInAnyOrder(testerAngular, testerSpringBoot);
	}
	...
	void providesUsersRelatedToGivenSkillId() {
		...
		// Then
		Assertions.assertThat(userSkills).hasSize(2);
		Assertions.assertThat(userSkills).containsExactlyInAnyOrder(angularDeveloper, angularTester);
	}
	...
	void providesUsersRelatedToGivenSkillIdWithAtLeastGivenPriority() {
		...
		// Then
		Assertions.assertThat(userSkills).hasSize(1);
		Assertions.assertThat(userSkills).containsExactlyInAnyOrder(angularDeveloper);
	}
	...
	void providesTop10PrioritizedSkills() {
		...
		// Then
		Assertions.assertThat(prioritizedSkills).hasSize(2);
		Assertions.assertThat(prioritizedSkills).containsExactly(
